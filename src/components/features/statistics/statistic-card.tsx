...
> = {
  ...
  success: {
    iconBg: "color-mix(in oklch, var(--success) 12%, transparent)",
    iconBorder: "color-mix(in oklch, var(--success) 30%, transparent)",
    iconColor: "var(--success)",
    glow: "color-mix(in oklch, var(--success) 6%, transparent)",
    bar: "linear-gradient(90deg, var(--success), color-mix(in oklch, var(--success) 60%, var(--accent)))",
    trendUp: "var(--success)",
    trendDown: "var(--destructive)",
  },
  warning: {
    iconBg: "color-mix(in oklch, var(--warning) 14%, transparent)",
    iconBorder: "color-mix(in oklch, var(--warning) 35%, transparent)",
    iconColor: "var(--warning)",
    glow: "color-mix(in oklch, var(--warning) 7%, transparent)",
    bar: "linear-gradient(90deg, var(--warning), color-mix(in oklch, var(--warning) 60%, var(--accent)))",
    trendUp: "var(--success)",
    trendDown: "var(--destructive)",
  },
};
